...
extern void draw_image(uint8_t *ssd,  uint8_t *image, int x_start, int y_start);
extern void draw_selected(uint8_t *ssd, int option);
extern void draw_relogio(uint8_t *ssd, int day, int month, int year, int hour, int min, int sec);
extern char* int_to_two_digit_str(int value);
extern void draw_menu_light(uint8_t *ssd, struct render_area *frame_area, int option);
extern void clear_display(uint8_t *ssd, struct render_area *frame_area);
extern void draw_4_selected(uint8_t *ssd, int option);